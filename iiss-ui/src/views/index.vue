    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="24">
        <blockquote class="text-warning" style="font-size: 14px">
          ...
          <br />
          <el-link
            href="https://www.aliyun.com/minisite/product?userCode=brki8iof"
            type="primary"
            target="_blank"
            >https://www.aliyun.com/minisite/product?userCode=brki8iof</el-link
          >
          <br />
          领取腾讯云通用云产品2860优惠券
          <br />
      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          ...
          <el-collapse accordion>
            <el-collapse-item title="v1.0.0 - 2022-10-01">
              <ol>
                <li>数据逻辑删除不进行唯一验证</li>
