package cn.iiss.openAI.listener;
...
public class OpenAISSEEventSourceListener extends EventSourceListener {
    ...
    public OpenAISSEEventSourceListener(SseEmitter sseEmitter, String uid, OpenAIUserInfoMapper openAIUserInfoMapper) {
        this.sseEmitter = sseEmitter;
        this.uid = uid;
        this.openAIUserInfoMapper = openAIUserInfoMapper;
        this.resData="";
    }
    ...
    public void onEvent(EventSource eventSource, String id, String type, String data) {
        ...
        if (data.equals("[DONE]")) {
            ...
            sseEmitter.complete();
            //保存数据到数据库中
            OpenAiUserInfo openAiUserInfo = new OpenAiUserInfo(Long.valueOf(uid), false, resData);
