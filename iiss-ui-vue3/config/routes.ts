  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        name: 'Warehouseasset',
        icon: 'PartitionOutlined',
        path: '/warehouse/warehouseasset',
        component: 'warehouse/warehouseasset',
        access: 'authorize',
        wrappers: ['@/components/KeepAlive'],
        KeepAlive: true,
      ...
      },
      {
        ...
        wrappers: ['@/components/KeepAlive'],
        KeepAlive: true,
        title: 'menu.title.category',
      },
      {
        name: 'Product',
        icon: 'PartitionOutlined',
        path: '/warehouse/products/product',
        component: 'product/goods',
        access: 'authorize',
        wrappers: ['@/components/KeepAlive'],
        KeepAlive: true,
        title: 'menu.title.product',
      },
      {
        name: 'Asset',
        icon: 'PartitionOutlined',
        path: '/warehouse/asset',
        component: 'warehouse/asset',
        access: 'authorize',
        wrappers: ['@/components/KeepAlive'],
        KeepAlive: true,
      ...
      },
      {
        name: 'Adjustment',
        icon: 'PartitionOutlined',
        path: '/warehouse/asset/adjustment',
        component: 'warehouse/asset/adjustment/Adjustment',
        access: 'authorize',
        wrappers: ['@/components/KeepAlive'],
        KeepAlive: true,
        title: 'menu.title.adjustment',
      },
      {
        name: 'ExWarehouse',
        icon: 'PartitionOutlined',
        path: '/warehouse/asset/exwarehouse',
        component: 'warehouse/asset/exwarehouse/ExWarehouse',
        access: 'authorize',
        wrappers: ['@/components/KeepAlive'],
        KeepAlive: true,
        title: 'menu.title.exwarehouse',
      },
      {
        name: 'WarehouseHousing',
        icon: 'PartitionOutlined',
        path: '/warehouse/asset/warehousing',
        component: 'warehouse/asset/warehousing/Warehousing',
        access: 'authorize',
        wrappers: ['@/components/KeepAlive'],
        KeepAlive: true,
        title: 'menu.title.warehousing',
      },
    ],
  },
